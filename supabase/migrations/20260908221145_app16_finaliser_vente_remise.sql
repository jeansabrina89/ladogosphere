-- ── APP 16 : la vente au comptoir emporte la remise de la ligne ───────────
--
-- Seul l'insert des lignes change : le prix payé reste `prix_unitaire`, et les
-- quatre colonnes de remise le suivent, en vente comme en facture. Le reste de
-- la fonction est identique — écriture, stock, journal, idempotence.
