-- Un article sur mesure n'a pas de stock de produit fini : sa vente n'en sort
-- pas, son retour n'en rend pas. Ce sont ses fournitures qui se décomptent, au
-- passage en fabrication. Sans cette exception, un retour de commande sur
-- mesure était refusé par le garde-fou de stock.
...
begin
  ...
  -- Le stock remonte : quantité positive, type « retour ». Un article sur
  -- mesure en est exclu — il n'en avait pas sorti.
