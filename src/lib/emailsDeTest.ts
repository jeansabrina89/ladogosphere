...
export const TYPES_EMAIL_TEST: readonly TypeEmailTest[] = [
  ...
  { cle: "rappel_veille", libelle: "Rappel de la veille (séjour)", fonction: "envoyerEmailRappelVeille", typeJournal: "rappel_veille" },
  { cle: "rappel_veille_essai", libelle: "Rappel de la veille (journée d'essai)", fonction: "envoyerEmailRappelVeille", typeJournal: "rappel_veille" },
  ...
  { cle: "commande_confirmee", libelle: "Commande enregistrée (facture jointe)", fonction: "envoyerEmailCommandeConfirmee", typeJournal: "commande_confirmee" },
